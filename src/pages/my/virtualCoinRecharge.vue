<template>
	<div class="virtual-coin-recharge">
		<HeaderTop :title="`虚拟币ERC20`"></HeaderTop>
		...
		<div class="bottom-reminds">
			...
			<div class="bottom-reminds-gray" v-html="explain"></div>
		</div>
...
export default {
	...
	methods: {
		...
		getVirtualCoinAccountSys() {
			this.ServerAPI.postAPI(this.API.virtualCoinListSys, '', (success, data) => {
				if (success) {
					if (data.code == '0000') {
