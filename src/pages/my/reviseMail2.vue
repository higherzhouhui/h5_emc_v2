<template>
	<div class="password-retrieval">
		<HeaderTop :title="`绑定新邮箱`"></HeaderTop>
        <div class="topP">
			<div class="pw-banner">
				<div class="revise-account-input-left">新邮箱地址</div>
				<div class="revise-account-input-box">
					<input type="text" ref="userMail" placeholder="请输入新邮箱地址">
				</div>
			</div>
			<div class="pw-banner">
...
import Submit from '../../components/submit/muSubmit';
...
export default {
	...
	data(){
		return{
			data:[
				{text:'新邮箱地址',placeholder:'请输入新邮箱地址'},
				{text:'验证码',placeholder:'验证码',hasBtn:true,func:this.sendMail}
			],
			showFlag:false,
			isFirst:''
		}
